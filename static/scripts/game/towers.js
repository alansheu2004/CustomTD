var defaultTowerTypes = [
	new TowerType("Peashooter", 25, true, false,
					[
						...
						[
							new TowerUpgrade("Threepeater", 375, 180,
							...
							new TowerUpgrade("Snow Pea", 425, 160,
	...
	new TowerType("Starfruit", 25, false, false,
					[
						...
						[
							new TowerUpgrade("Superstar", 450, 160,
							...
							new TowerUpgrade("Gravistar", 500, 180,
	...
	new TowerType("Iceshroom", 30, false, false,
					[
						...
						[
							...
							new TowerUpgrade("Climate Change", 350, 180,
	...
	new TowerType("Cabbage-pult", 30, true, false,
					[
						...
						[
							...
							new TowerUpgrade("Melon-pult", 575, 200,
